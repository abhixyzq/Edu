...
/**
 * 🚀 Dedicated nainixOne Brand Insignia Logo
 */
export const NainixOneLogo: React.FC<IconProps> = ({ size = 32, className = '' }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 48 48"
  ...
  >
    <defs>
      <linearGradient id="nxLogoBg" x1="6" y1="6" x2="42" y2="42" gradientUnits="userSpaceOnUse">
        <stop offset="0%" stopColor="#8B5CF6" />
        <stop offset="60%" stopColor="#6D28D9" />
        <stop offset="100%" stopColor="#4C1D95" />
      </linearGradient>
      <linearGradient id="nxLogoN" x1="14" y1="12" x2="34" y2="36" gradientUnits="userSpaceOnUse">
        <stop offset="0%" stopColor="#FBBF24" />
        <stop offset="100%" stopColor="#F59E0B" />
      </linearGradient>
    </defs>
    {/* Squircle Background Base */}
    <rect x="4" y="4" width="40" height="40" rx="12" fill="url(#nxLogoBg)" />
    {/* Stylized Futuristic "N1" Monogram */}
    <path
      d="M14 34V14L28 34V14"
      stroke="white"
      strokeWidth="4"
      strokeLinecap="round"
      strokeLinejoin="round"
    ...
    />
    {/* Orbital Sparkle Dot */}
    <circle cx="34" cy="11" r="2.5" fill="#FEF08A" />
  </svg>
);
