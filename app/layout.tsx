...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'BSEB Class 12 Objective Questions',
    'UP Board Class 12 Model Paper 2026',
    'ICSE ISC Board Exam Practice',
    'Maharashtra State Board HSC Exam',
    'Class 9 Class 10 Class 11 Class 12 Exam Prep',

    // Subject Wise Keywords
    'Class 12 Physics MCQ Practice',
    'Class 12 Chemistry Objective Questions',
    'Class 12 Mathematics Sample Papers',
    'Class 12 Biology Board & NEET MCQ',
    'Class 12 English Core Questions',
    'Class 12 Hindi Core Model Paper',
    'NCERT Chapterwise Objective Test',
    'Class 12 Previous Year Questions PYQ',

    // Platform Features & Gamification
    'Gamified Education Platform India',
    'Duolingo for Indian Board Exams',
    'Free Online Mock Test Series 2026',
    'Instant Test Results & Score Analytics',
    'State Rank Leaderboards & Quests',
    'Daily Study Streak & XP Rewards',
    'Interactive Chapter Roadmaps',
    'Best Free Board Exam Preparation Website',
  ],
