      ...
      <main className="w-full max-w-sm bg-white border border-[#ddc1b3]/60 rounded-3xl p-6 shadow-md flex flex-col my-auto">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3.5">
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="relative w-full border border-[#ddc1b3] rounded-xl bg-white flex items-center overflow-hidden focus-within:border-[#9b4500] focus-within:ring-1 focus-within:ring-[#9b4500] transition-all">
              ...
              <input
                ...
                className="w-full bg-transparent border-none py-2.5 px-2.5 text-xs text-[#161d1f] placeholder:text-[#897266] outline-none"
              />
            </div>
          </div>
          ...
          <button
            type="submit"
            className="w-full bg-[#9b4500] hover:bg-[#ff8c42] text-white font-bold text-xs py-3 rounded-full transition-all shadow-xs active:scale-[0.98] mt-1 cursor-pointer"
          >
            Login
          </button>
          ...
          <button
            type="button"
            onClick={() => router.push('/')}
            className="w-full bg-white border border-[#ddc1b3] text-[#161d1f] font-bold text-xs py-2.5 rounded-full flex items-center justify-center gap-2.5 hover:bg-[#f4fafd] transition-all shadow-xs cursor-pointer"
          >
        ...
        {/* Footer Link */}
        <div className="mt-5 text-center pt-3 border-t border-[#dde4e6]">
