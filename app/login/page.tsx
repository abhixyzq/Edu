            ...
            <form onSubmit={handleSubmit} className="w-full flex flex-col gap-4">
              ...
              <div className="grid grid-cols-2 gap-2 mt-1">
                <button
                  ...
                  className="h-10 rounded-xl bg-blue-50 border-2 border-slate-900 text-blue-700 font-extrabold text-xs flex items-center justify-center gap-1.5 shadow-[0_2px_0_#0f172a] active:shadow-none active:translate-y-0.5 transition-all cursor-pointer"
                >
                ...
                <button
                  type="button"
                  onClick={() => router.push('/')}
                  className="h-10 rounded-xl bg-white border-2 border-slate-900 hover:bg-slate-50 text-slate-700 font-extrabold text-xs flex items-center justify-center gap-1.5 shadow-[0_2px_0_#0f172a] active:shadow-none active:translate-y-0.5 transition-all cursor-pointer"
                >
